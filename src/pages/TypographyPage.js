...
class TypographyPage extends React.Component {
    constructor(props) {
        ...
        this.state = {
            posts: [
                { id: 1, caption: 'Post 1', mediaUrl: 'https://via.placeholder.com/150' },
                { id: 2, caption: 'Post 2', mediaUrl: 'https://via.placeholder.com/150' },
                { id: 3, caption: 'Post 3', mediaUrl: 'https://via.placeholder.com/150' },
                { id: 4, caption: 'Post 4', mediaUrl: 'https://via.placeholder.com/150' },
    ...
    render() {
        ...
        // Calculate indices for slicing post data
        ...
        return (
            <>
                <div className="container-fluid">
                    <div className="row">
                        <div className="col-12">
                            <h1 className="my-4">Typography Page</h1>
                        </div>
                    </div>
                        ...
                        <div className="col-lg-6 mb-4">
                            <div className="card text-white bg-primary o-hidden h-100">
                                <div className="card-body">
                                    ...
                                    <div className="mr-5">Total Posts: 50</div>
                                </div>
                        ...
                        <div className="col-lg-6 mb-4">
                            <div className="card text-white bg-warning o-hidden h-100">
                                <div className="card-body">
                                    ...
                                    <div className="mr-5">Posts Published in Last 24 Hours: 10</div>
                                </div>
                                <a className="card-footer text-white clearfix small z-1" href="#">
                                    <span className="float-left">View Details</span>
                                    <span className="float-right">
                    ...
                    <div className="table-container">
                        <div className="row">
                            <div className="col">
                                <h5 className="pb-2 mb-0">Posts List</h5>
                            </div>
                            <div className="col text-right">
                                <button className="btn btn-default low-height-btn">
                                    <i className="fa fa-plus"></i>
                        ...
                        <div className="d-flex text-muted">
                                ...
                                <tbody>
                                    {currentPosts.map(post => (
                                        <tr key={post.id}>
                                            ...
                                            <td>{post.id}</td>
                                            <td>{post.caption}</td>
                                            <td><a href={post.mediaUrl} target="_blank" rel="noopener noreferrer">{post.mediaUrl}</a></td>
                                            <td>23-aug-2019</td>
                                            <td>26-aug-2019</td>
                                            <td>
                                                <div className="dropdown table-action-dropdown">
                                                    <button className="btn btn-secondary btn-sm dropdown-toggle" type="button" id={`dropdownMenuButtonSM-${post.id}`} data-bs-toggle="dropdown" aria-expanded="false">
                                                        <i className="fa fa-ellipsis-v" aria-hidden="true"></i>
                                                    </button>
                                                    <ul className="dropdown-menu" aria-labelledby={`dropdownMenuButtonSM-${post.id}`}>
                                                        <li><a className="dropdown-item text-danger" href="#"><i className="fa fa-trash" aria-hidden="true"></i>&nbsp;Delete</a></li>
                                                        <li><a className="dropdown-item text-secondary" href="#"><i className="fa fa-eye-slash" aria-hidden="true"></i>&nbsp;Hide</a></li>
                                                    </ul>
                                                </div>
                                            </td>
                                        </tr>
                            ...
                            <nav className="table-bottom-center-pagination" aria-label="Page navigation example">
                                <ul className="pagination">
                                    <li className="page-item">
                                        <a className="page-link" href="#" aria-label="Previous" onClick={() => this.handlePageChange(currentPage > 1 ? currentPage - 1 : 1)}>
                                            <span aria-hidden="true">&laquo;</span>
                                            <span className="sr-only">Previous</span>
                                        </a>
                                    </li>
                                    ...
                                    <li className="page-item">
                                        <a className="page-link" href="#" aria-label="Next" onClick={() => this.handlePageChange(currentPage < pageNumbers.length ? currentPage + 1 : pageNumbers.length)}>
                                            <span aria-hidden="true">&raquo;</span>
                                            <span className="sr-only">Next</span>
                                        </a>
                                    </li>
